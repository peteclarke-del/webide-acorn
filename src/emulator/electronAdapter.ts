...
export const ELECTRON_UNAVAILABLE: Readonly<Record<string, string>> = Object.freeze({
  ...
  beebscsi: 'A BeebSCSI board hangs off the 1 MHz bus, which a stock Electron does not have. The board needs a Plus 1 and a 1 MHz bus adaptor, and neither core here models one.',
...
export const ELECTRON_COMMAND_CAPABILITY: Readonly<Record<string, string>> = Object.freeze({
  ...
  'eject-disc': 'media',
  'export-disc': 'media',
  'load-scsi-lun': 'beebscsi',
  'eject-scsi-lun': 'beebscsi',
