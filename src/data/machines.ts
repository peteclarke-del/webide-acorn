...
export const machineProfiles: MachineProfile[] = [
  ...
  },
  {
    ...
    capabilities: [
      ...
      capability('tube', 'Tube second processor', 'The pinned core gets further than it looks and still stops short. The host writes the ULA control register and releases the parasite, and the parasite runs its own ROM, but the language is never transferred and the screen keeps the host banner. It boots on the Master, so this is the machine and not the feature', 'planned'),
      capability('econet', 'Econet', 'Network interface and NFS ROM', 'planned'),
