...
export const machineProfiles: MachineProfile[] = [
  ...
  },
  {
    ...
    capabilities: [
      ...
      capability('tube-turbo', '65C102 Turbo second processor', 'A 65C102 behind the same Tube, at 4 MHz rather than 3. Acorn sold this board for the Master and not for this machine, but a PiTube Direct puts one behind whatever it is plugged into, and the parasite ROM introduces itself as Acorn TUBE 65C102 Co-Processor here too', 'supported'),
      capability('econet', 'Econet', 'Network interface and NFS ROM', 'planned'),
