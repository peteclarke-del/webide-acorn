...
| Acorn BBC Model B | DFS disk system, Cassette interface, Sideways RAM, VideoNuLA | BeebSID, 1MHzPi WiFi ROM | Tube second processor, Econet, Speech system |
| Acorn BBC B+ | Shadow screen RAM, Paged RAM at &8000, VideoNuLA, Cassette interface, 1770 DFS, ADFS | BeebSID, 1MHzPi WiFi ROM | Tube second processor, Econet |
| Acorn Electron | Cassette interface | Plus 1 expansion, Plus 3 expansion | Sideways RAM, Joystick interface, 1MHzPi / ElkWiFi |
| BBC Master Series | Cassette interface, Shadow & Hazel RAM, Sideways RAM, VideoNuLA, ADFS, DFS, Tube / Turbo | BeebSID, 1MHzPi WiFi ROM | Econet |
