...
| 65C102 Turbo Tube boot ROM | extension | optional · needed for tube-turbo | 2 KiB | `os12-basic2-dfs/tube/65C102Tube.rom` | The parasite ROM for a 65C102 behind the Tube. Acorn sold this board for the Master; a PiTube Direct puts one behind any machine with a Tube interface. |
...
| 65C102 Turbo Tube boot ROM | extension | optional · needed for tube-turbo | 2 KiB | `os12-basic1/tube/65C102Tube.rom` | The parasite ROM for a 65C102 behind the Tube. Acorn sold this board for the Master; a PiTube Direct puts one behind any machine with a Tube interface. |
...
| 65C102 Turbo Tube boot ROM | extension | optional · needed for tube-turbo | 2 KiB | `os12-basic2-adfs/tube/65C102Tube.rom` | The parasite ROM for a 65C102 behind the Tube. Acorn sold this board for the Master; a PiTube Direct puts one behind any machine with a Tube interface. |
...
| 65C102 Turbo Tube boot ROM | extension | optional · needed for tube-turbo | 2 KiB | `bplus-os/tube/65C102Tube.rom` | The parasite ROM for a 65C102 behind the Tube. Acorn sold this board for the Master; a PiTube Direct puts one behind any machine with a Tube interface. |
...
| 65C102 Turbo Tube boot ROM | extension | optional · needed for tube-turbo | 2 KiB | `bplus-adfs/tube/65C102Tube.rom` | The parasite ROM for a 65C102 behind the Tube. Acorn sold this board for the Master; a PiTube Direct puts one behind any machine with a Tube interface. |
